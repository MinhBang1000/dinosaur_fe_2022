        ...
        <BrowserRouter>
          ...
          <div className="main__board container">
            <Switch>
              ...
              <Route exact path="/profile" render={(props) => <Profile background={() => {this.changBackground(false)}}  remove={() => {this.removeTokenStorage()}} logged={(accessToken,userID)=>{this.manageLogged(accessToken,userID)}} accessToken={this.state.accessToken}  userID={this.state.userID}  choose={(index) => {this.chooseNavbarItem(index)}} {...props}/>}></Route>
